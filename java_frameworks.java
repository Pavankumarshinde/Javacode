...
public class java_frameworks {
    public static void main(String[] args) {
        ...
        // ArrayList<String> list = new ArrayList<>(); // declear a list.
        // list.add("A");
        // list.add("B");
        // list.add("C");
        ...
        // System.out.println("After adding at index 1: " + list); // A X B C
        // list.remove("C"); // Remove element
        // System.out.println("After removing 'C': " + list); // A X B
        ...
        // HashSet<String> set = new HashSet<>(); // declear a set
        // set.add("A");
        // set.add("B");
        ...
        // set.remove("B");
        // System.out.println("After removing 'B': " + set); // A , c
        ...
        // System.out.println("TreeSet: " + treeSet); // 5,1,3
        ...
        //  key --> value.
        //  
        // HashMap<Integer, String> map = new HashMap<>(); // declear a hashmap
        // map.put(1, "One");
        // map.put(2, "Two");
        // map.put(3, "Three");
